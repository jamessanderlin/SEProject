...
public class UserInterface extends javax.swing.JFrame { 
    ...
    public UserInterface() {        
        ...
        // Allows the the account panel to listen to all selection changes in
        // the account table. 
    ...
    //This code was generated by the GUI builder
    ...
    /**
     * Event to detect popup in the accoutn table. 
     * 
     * @param evt The event passed to this action.
     */
    ...
    /**
     * Event to detect popup in the account table. 
     * 
     * @param evt The event passed to this action.
     */
    ...
    /**
     * Responds to clicks in the accoutn table. 
     * 
     * @param evt 
     */
    ...
    /**
     * Responds to the residential account button in the account panel. 
     * @param evt 
     */
    ...
    /**
     * Responds to the commercial account button in the account panel. 
     * 
     * @param evt 
     */
    ...
    /**
     * Responds to the cancel button in the account panel. 
     * @param evt 
     */
    ...
    /**
     * Responds to the create button in the acocunt panel. 
     * @param evt 
     */
    ...
    /**
     * Responds to the view meter action in the account drop down. 
     * @param evt 
     */
    ...
    /**
     * Responds to right clicks in the meter table view. 
     * 
     * @param evt 
     */
    ...
    /**
     * Responds to the addd meter reading button in the view meter panel. 
     * 
     * @param evt 
     */
    ...
    /**
     * Responds to the action to delete meter readings frm the meter reading 
     * popup.
     * @param evt 
     */
    ...
    /**
     * Responds to right clicks in the meter reading table. 
     * @param evt 
     */
    ...
    /**
     * Responds to clicks in the meter table. Double clicks open the view meter panel. 
     * @param evt 
     */
    ...
    /**
     * Responds to the delete meter reading button in the view meter panel. 
     * @param evt 
     */
    ...
    /**
     * Responds to delete meter actions from the mter table popup.
     * @param evt 
     */
    ...
    /**
     * Responds to the quick add meter reading action from the meter table popup.
     * 
     * @param evt 
     */
    ...
    /**
     * Responds to teh add tax button in the meter view panel. 
     * @param evt 
     */
    ...
    /**
     * Responds to the quick add tax action from the meter view table. 
     * 
     * @param evt 
     */
    ...
    /**
     * Responds to the delete tax action in the tax popup. 
     * @param evt 
     */
    ...
    /**
     * Responds to the delete tax button in the meter view panel. 
     * @param evt 
     */
    ...
    /**
     * Responds to right clicks in the tax table. 
     * @param evt 
     */
    ...
    /**
     * Responds to the view payments action in the account panel
     * @param evt 
     */
    ...
    /**
     * Responds to the add payment button in the view payments panel. 
     * @param evt 
     */
    ...
    /**
     * Respond to the delete button the payments panel. 
     * @param evt 
     */
    ...
    /**
     * Responds to teh action to quickly add a payment to an account. 
     * @param evt 
     */
    ...
    /**
     * Responds right clicks in the payment table. 
     * @param evt 
     */
    ...
    /**
     * Responds to the acction to delete a payment from teh drop down. 
     * @param evt 
     */
    ...
    /**
     * Responds to the action to generate bills for all accounts. 
     * @param evt 
     */
    ...
    /**
     * Responds to the action to generate a bill for a certain account. 
     * @param evt 
     */
    ...
    /**
     * Responds to the action to edit an accoutn balance. 
     * @param evt 
     */
     ...
     * if a proper account could not be created. The only field currently 
     * checked is the account ID. 
     * 
     * @return 
     */
    ...
    /** 
     * Helper method to get the meter that was entered in the view meter panel. 
     * returns null if if could create a proper meter form the method. 
     * 
     */
    ...
    /**
     * Opens the panel for generating the bills. The panel prompts the user for 
     * two dates. The method then returns the two dates that the user entered. 
     * If the method could not create dates from the entered values, it return 
     * null, and informs the user that it could not create the bill. 
     * 
     * @return 
     */
    ...
    /**
     * Opens the panel to edit the balance for an account. If the method could
     * not edit the balance, it informs the user. 
     * 
     */
    ...
    /**
     * Method that displays the view payment panel for a selected account
     * 
     */
    ...
    /**
     * Method that opens the add payment panel. If the user opts to add a 
     * payment, the method adds it to the selected account. If for some reason
     * the method could not create the account, it informs the user. 
     * 
     */
    ...
    /**
     * Opens the add tax panel in a JDialog. If the user opts to add a tax, the 
     * method creates the tax. If the method cannon create the tax, it informs 
     * the user. 
     * 
     */
    ...
    /**
     * Opens the panel to add a meter to the currently selected account. If 
     * the user tries to add a meter to a residential account with a meter 
     * already, the method informs the user of the conflict and asks to 
     * continue. If the meter could not be added, the method informs the user. 
     * 
     */
    ...
    { 
        ...
        if(result == 0)
        {
            ...
            {    
                ...
                //Use this method as opposed to updateJTable because of how
                //the table model for meters is created froma accounts
    ...
    /**
     * This method opens the panel to add a meter reading. It then creates the 
     * meter reading and adds it to the appropriate meter. If the meter reading 
     * could not be created, it opens a dialog informing the user of this issue. 
     * 
     */
    ...
    /**
     * This method actually opens the view meter panel. It relies on the  
     * showMeterInViewMEterPanel() method to display the meter in the panel. 
     * When the JDialog is closed, it checks to see if the meter information was
     * edited, and edits the appropriate information if it was valid. 
     *
     */
    ...
    /**
     * Shows a meter in the meter panel. This method does not actually open the
     * view meter panel. 
     * 
     * @param m The meter to display in the view Meter panel. 
     */
    ...
    /**
     * Returns the meter that the user enters into the panel. Returns null
     * if a meter could not be created because of improper values. 
     * 
     * @return 
     */
    ...
    /**
     * Helper method to show an account in the account panel.  
     * 
     * @param temp The account to display in the account panel. 
     */
    private void showInAccountPanel(Account temp)
    {
        ...
        //Handle resisdential and commercial accounts slightly differently
        //Depending on which type, enable or disable certain fields. 
        if(temp instanceof ResidentialAccount)
        {
            ResidentialAccount resAcc = (ResidentialAccount)temp;
    ...
    /**
     * Helper method for the account panel to show the meters of a specific 
     * account in the meter table. 
     * 
     * @param acc The account whose meters to display. 
     */
    ...
    /**
     * Convinience method to tell a table to update itself. The table must have 
     * a model that extend AbstractTableModel.
     * 
    ...
    /**
     * Returns the ID of the currently selected meter. If there is no selected
     * meter the method return -1. It also return -1 if for some reason the 
     * meter table doesn't return an integer. 
     * 
     * @return 
     */
    ...
    /**
     * Returns the meter that the user currently has selected. If there is no 
     * currently selected meter, return null.
     * 
     * @return 
     */
     ...
     * for some reason the accountTable does not return an Integer. Also returns
     * negative one if there is no selected account. 
     * 
     * @return 
     */
    ...
    /**
     * Returns the account that the user currently has selected. If the account 
     * was not found the method return null;
     * 
     * @return The account that the user has selected. 
     */
    ...
    /**
     * Enables or disables the buttons in the accoutn panel based on the boolean
     * passed to it. 
     * 
     * @param enable The boolean to set the enabled field to. 
     */
    ...
    /**
     * Deletes the curretnly selected meter in the meter reading table. If there
     * was no currently selected meter reading, nothign happens. 
     */
    ...
    /**
     * Deletes the currently selected Tax in the tax table. If there was no 
     * selected Tax. Nothing happens. 
     * 
     */
    ...
    /**
     * Deletes the currently selected payment in the payment table. If there was
     * no selected payment, nothing happens. 
     * 
     */
...
//    }
    ...
    //All of these variable declartions were handled by the gui editor. 
